...
| leftLedgeGrabLayerType | Int | `0` | Determines the layering strategy of character left ledge grabs on this structure (StructureType.FLOOR only). |
...
| rightLedgeGrabLayerType | Int | `0` | Determines the layering strategy of character right ledge grabs on this structure (StructureType.FLOOR only). |
